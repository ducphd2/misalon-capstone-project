...
export enum EBullEvent {
  ...
  ADMIN_RESPONSE_BOOKING = 'ADMIN_RESPONSE_BOOKING',
  ...
  SEND_EMAIL_VERIFY_OTP = 'send_email_verify_otp',
  SEND_MESSAGE = 'SEND_MESSAGE',
  MERCHANT_FORGOT_PASSWORD_REQUEST = 'MERCHANT_FORGOT_PASSWORD_REQUEST',
}
